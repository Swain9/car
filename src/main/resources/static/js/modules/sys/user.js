...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function () {
            ...
            var url = vm.user.userId == null ? "system/user/save" : "system/user/update";
            $.ajax({
                type: "POST",
                url: baseURL + url,
                contentType: "application/json",
        ...
        getUser: function (userId) {
            $.get(baseURL + "system/user/info/" + userId, function (r) {
                vm.user = r.data;
                vm.user.password = null;
            });
        },
        getRoleList: function () {
            $.get(baseURL + "system/role/select", function (r) {
                vm.roleList = r.data;
            });
        },
        reload: function () {
