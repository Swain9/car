package cn.yuntangnet.duizhang.genarator;
...
public class MapperGenerator extends DuizhangApplicationTests {
    ...
    public void generator() {
        ...
        strategy.setInclude(new String[]{"system_wechat", "system_work_order","system_work_order_flow","system_user_wechat"}); // 需要生成的表
        ...
        */
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return "/develop/" + tableInfo.getEntityName() + ".xml";
            }
        });
        cfg.setFileOutConfigList(focList);
        mpg.setCfg(cfg);
